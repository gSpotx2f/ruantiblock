# Ruantiblock для прошивки от Padavan больше не обновляется. Актуальная версия данного решения для OpenWrt находится [здесь](https://github.com/gSpotx2f/ruantiblock_openwrt)...
